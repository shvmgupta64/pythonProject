...
if __name__ == '__main__':
    ...
    trade_log = ['Symbol','Buy-Sell', 'Future_Traded_Price', 'Days_to_Expiry', 'Entry_Datetime', 'Entry_Price','Exit_Datetime',
                 'Exit_Price', 'PnL']
    ...
    for file_path in files:
        ...
        #bnf_options_df.to_csv("C://Historical Data//BANKNIFTY_OPTIONS.csv")
        ...
        #bnf_options_five_min_df.to_csv("C://Historical Data//BANKNIFTY_OPTIONS.csv")
        ...
        for index, row in banknifty_itraday_df.iterrows():
            ...
            if row['Time'] == constants.FIRST_STRADDLE_TIME:
                ...
                print(ce_straddle_entry_price)
                print(pe_straddle_entry_price)
                print(ce_straddle_symbol)
                print(pe_straddle_symbol)
